                    ...
                    <table class="table table-hover">
                        ...
                        @foreach ($employees as $employee => $value)
                            @php
                                ...
                                $employee_rates = DB::table('employee_rates')->where('employee_id',$value->id)
                        ...
                        <tbody class="table-border-bottom-0">
                            <tr>
                                ...
                                <td>{{$position}}</td>
                                <td>
                                    <a href="{{url('/admin/evaluate-detail')}}/{{$value->id}}"><i class='bx bxs-bar-chart-alt-2' ></i> ตรวจสอบผลการประเมิน</a>
                                </td>

                                @php
                                    $date = DB::table('employee_rates')->where('employee_id',$value->id)->orderBy('created_at','desc')->first();

                                    if($date == NULL) {
                                        $date_mY = NULL;

                                        $rate = DB::table('employee_rates')->where('employee_id',$value->id)
                                        ...
                                        $rateNow = DB::table('employee_rates')->where('employee_id',$value->id)
